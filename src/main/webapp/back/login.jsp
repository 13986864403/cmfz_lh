	...
	<script type="text/javascript">
		...
		$(function(){
            ...
            $("#captchaImage").click(function(){
				document.getElementById("captchaImage").src="${pageContext.request.contextPath}/code/code.do?"+new Date().getTime();
            });
				...
				<table>
					<tbody>
					  ...
					  <tr>
							...
							<td>
								<input type="password" name="password" class="text"  maxlength="4" autocomplete="off"/>
							</td>
					  </tr>
						...
						<tr>
							...
							<th>验证码:</th>
							<td>
								<input type="text" id="enCode" name="code" class="text" maxlength="20" autocomplete="off"/>
								<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/code/code.do" title="点击更换验证码"/>
							</td>
						</tr>					
					<tr>
						<td>
